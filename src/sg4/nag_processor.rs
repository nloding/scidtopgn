...
impl NagProcessor {
    ...
    pub fn nag_to_symbol(nag: u8) -> &'static str {
        match nag {
            ...
            24 => "○",     // White has slight space advantage
            25 => "○",     // Black has slight space advantage
            26 => "○",     // White has space advantage
            27 => "○",     // Black has space advantage
            28 => "○",     // White has decisive space advantage
            29 => "○",     // Black has decisive space advantage
