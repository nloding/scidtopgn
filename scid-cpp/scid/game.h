...
//    byte        GetCommentsFlag ()          { return CommentsFlag; }
    ...
    bool      SetPgnFormatFromString (const char * str);
     ...
     bool      IsHtmlFormat () { return false; /* HTML not supported */ }
     bool      IsLatexFormat () { return false; /* LaTeX not supported */ }
     bool      IsColorFormat () { return false; /* Color format not supported */ }
