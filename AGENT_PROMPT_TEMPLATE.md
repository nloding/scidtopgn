...
Copy this template and fill in the `[TASK]` placeholder to assign work to an agent.
...
```
[TASK]: Task 1.2.1 - Implement Error Types
```

### Example 2: Parser Task
```
[TASK]: Task 2.1.1 - Create Header Data Structure (Si4Header)
```

### Example 3: Multiple Sequential Tasks
```
[TASK]: Complete Section 2.1 (Tasks 2.1.1 through 2.1.4) - SI4 Header Parsing
```

### Example 4: Specific Bug Fix
```
[TASK]: Fix the date parsing in Task 2.2.4 - the year offset calculation is incorrect
```
...
Tasks are identified as: `[Phase].[Section].[Task]`

- Task 1.1.1 = Phase 1, Section 1, Task 1
- Task 4.3.2 = Phase 4, Section 3, Task 2

See `IMPLEMENTATION_GUIDE.md` for the full task list with line numbers.
