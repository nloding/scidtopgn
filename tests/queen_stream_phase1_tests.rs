...
mod tests {
    use scidtopgn::position::{
        decode_queen_with_stream, PieceType, ScidByteStream, ScidMove, Square,
    };
    ...
    fn test_queen_diagonal_move_with_stream() {
        ...
        assert!(
            result.is_ok(),
            "Diagonal queen move should succeed: {:?}",
            result
        );
    ...
    fn test_queen_diagonal_move_valid_target() {
        ...
        assert!(
            result.is_ok(),
            "Valid diagonal queen move should succeed: {:?}",
            result
        );
    ...
    fn test_queen_diagonal_geometry_validation() {
        ...
        assert!(result
            .unwrap_err()
            .contains("Invalid Queen diagonal move geometry"));
    }
